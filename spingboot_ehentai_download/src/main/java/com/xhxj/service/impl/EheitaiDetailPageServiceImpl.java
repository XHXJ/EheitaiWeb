...
//        EheitaiDetailPage byImgUrlAndPage = new EheitaiDetailPage();
    ...
    @Override
    public List<String> findByGidAndImgurl(Integer gid) {
        return eheitaiDetailPageDao.findByGidAndImgurl(gid);
    }

    //根据id去查询图片的下载地址和名称
    @Override
    public List<EheitaiDetailPage> findByGidAndImgurlGetName(Integer gid) {

        return eheitaiDetailPageDao.findByGidAndImgurlGetName(gid);
    }

    @Override
    public List<EheitaiDetailPage> findByGid(Integer i) {
        return eheitaiDetailPageDao.findByGid(i);
    }
}
